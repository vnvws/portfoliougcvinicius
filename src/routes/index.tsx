      ...
      <FixedScale>
        <main className="grain relative overflow-hidden bg-bone font-sans text-ink">
          ...
          <section className="relative">
            <div className="mx-auto w-[1240px] pb-4">
              <p className="font-sans text-[11px] tracking-[0.32em] text-forest uppercase">
...
function Nav() {
  return (
    <header className="relative z-20 mx-auto flex w-[1240px] items-center justify-between pt-9">
      <span className="font-display text-[18px] font-extrabold tracking-[-0.02em] uppercase">
        V.A<span style={{ color: "var(--color-neon)" }}>.</span>
      </span>
